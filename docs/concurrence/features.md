...
| **Données démographiques**                 | Données INSEE avancées selon plan                                     | Démographie selon plans (population, revenus, etc.)                       | Données socio‑démographiques accessibles (plus de 90 indicateurs)                  |
